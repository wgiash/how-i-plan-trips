...
export const PLAN = {
  ...
  title: 'Montauk Trip',
  tagline: 'Train out, everything on foot, one ride for the lighthouse.',
  desc: 'Day trip to the end of Long Island. Lighthouse first, then the beach with lunch on the sand, then dinner in town before the train home.',
  transit: [
